...
<body>
  ...
  <form action="{{ route('loginPost') }}" method="POST">
    ...
    <img src="{{ asset('/image/atlas-black.png') }}" class="mb-5" style="width:200px;">
          <div class="border vh-50 w-25" style="background:#FFF;border-radius: 20px;box-shadow: 0 10px 25px 0 rgba(0, 0, 0, .5);">
